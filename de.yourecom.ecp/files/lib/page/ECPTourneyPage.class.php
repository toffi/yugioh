...
class ECPTourneyPage extends SortablePage {
	public $templateName = 'ECPTourneyPage';
	...
	public function readData() {
		...
		if($this->sortField != NULL)
			...
			$sql = "SELECT
							...
							WHERE (events.art = '3' || events.art = '4') && events.status != '5' && events.status != '10'". $sortierung;
		...
		while ($row = WCF::getDB()->fetchArray()) {
			...
			switch ($row['art']) {
					case 3:
							...
							break;
					case 4:
							$row['artName'] = 'wcf.ecp.tourney.insert.tourney.vorrunde';
							break;
			}
