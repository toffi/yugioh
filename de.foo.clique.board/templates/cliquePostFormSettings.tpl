...
{if $this->request->form == 'CliquePostAddForm' && MODULE_THREAD_MARKING_AS_DONE && $board->enableMarkingAsDone && !$thread->isDone && ($board->getModeratorPermission('canMarkAsDoneThread') || ($this->user->userID && $this->user->userID == $thread->userID && $board->getPermission('canMarkAsDoneOwnThread')))}
	<div class="formField">
...
{/if}
{if $this->request->form == 'CliqueThreadAddForm' && $board->getModeratorPermission('canEnableThread')}
	<div class="formField">
...
{/if}
{if $this->request->form == 'CliquePostAddForm' && $board->getModeratorPermission('canEnablePost')}
	<div class="formField">
