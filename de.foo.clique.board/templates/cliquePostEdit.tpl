...
<div id="main">
	...
	<form enctype="multipart/form-data" method="post" action="index.php?form=CliquePostEdit&amp;cliqueID={@$clique->cliqueID}&amp;postID={@$post->postID}">
		<div class="container-1">

{* postEdit.tpl start *}
			
				{if $form->canDeletePost() && $cliquePermissions->getCliquePermission('canDeletePosts')}
					<fieldset>
