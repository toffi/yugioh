...
<div id="main">
	{include file="cliqueNavigation" showThread=true}
	...
	<form enctype="multipart/form-data" method="post" action="index.php?form=CliquePostAdd&amp;cliqueID={@$clique->cliqueID}&amp;threadID={@$thread->threadID}">
			<div class="container-1">
				...
				<fieldset>
					...
					{include file='cliquePostFormSettings' append=additionalSettings}
			...
			<div class="messageInner container-{cycle values='1,2'}">
				<div class="messageHeader">
					<p class="messageCount">
						<a href="index.php?page=CliqueThread&amp;postID={@$post->postID}#post{@$post->postID}{@SID_ARG_2ND}" title="{lang}wbb.thread.permalink{/lang}" class="messageNumber">{#$startIndex}</a>
					</p>
