...
<form method="post" action="index.php?form=CliquePostQuickAdd&amp;cliqueID={$cliqueID}&amp;threadID={@$thread->threadID}">
	<div class="quickReply message content messageMinimized hidden" id="quickReplyContainer-{@$thread->threadID}">
		<div class="messageInner container-1">
			...
			<div class="hidden" id="quickReplyInput-{@$thread->threadID}">
				...
				<div class="formSubmit" id="quickReplyButtons-{@$thread->threadID}">
