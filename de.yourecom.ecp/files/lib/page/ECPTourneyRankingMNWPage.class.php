...
class ECPTourneyRankingMNWPage extends AbstractPage {
	public $templateName = 'ECPTourneyRankingMNW';
		...
		parent::readData();
			...
			$sql = "SELECT events.id, events.officialEvent, COUNT(events_paarungen.userID1) AS userID1, 
							...
							WHERE events.art = '3' && events_paarungen.event_round = '1' && events_paarungen.userID1 != '0' && 
								events_paarungen.userID2 != '0' && events.status = '10' && events.officialEvent = '1'&&
