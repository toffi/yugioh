...
class CliquePostReportListener implements EventListener {
	...
	public function execute($eventObj, $className, $eventName){
		...
		HeaderUtil::redirect('index.php?page=CliqueThread&cliqueID='.$eventObj->cliqueID.'&postID='.$eventObj->postID.SID_ARG_2ND_NOT_ENCODED.'#post'.$eventObj->postID);
		exit;
	}
}
?>